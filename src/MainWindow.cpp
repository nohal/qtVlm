...
MainWindow::MainWindow(QWidget *parent)
{
    ...
    else
    {
        ...
        "QWidget:item:hover{"
            "background-color: QLinearGradient( x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #ffa02f, stop: 1 myColor3);"
            "color: #000000;}"
        ...
        "QComboBox::down-arrow{"
             "image: url(img/o_down_arrow.png);}"
        ...
        "QDockWidget::title{"
            ...
            "background-color: QLinearGradient(x1:0, y1:0, x2:0, y2:1, stop:0 myColor1, stop: 0.5 #242424, stop:1 myColor1);}"
        ...
        "QToolBar::handle{"
             "spacing: 3px; /* spacing between items in the tool bar */"
             "background: url(img/o_handle.png);}"
        ...
        "QCheckBox::indicator:disabled, QRadioButton::indicator:disabled{"
            "border: 1px solid #444;}";
        qApp->setStyleSheet(darkOrangeStyle);
    }
#endif
#endif
    isStartingUp=true;
