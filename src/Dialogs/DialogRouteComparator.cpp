...
void DialogRouteComparator::insertRoute(const int &n)
{
    ...
    if(x%2!=0) items[x]->setData(QColor(240,240,240),Qt::BackgroundRole);
    items[x++]->setTextAlignment(Qt::AlignRight| Qt::AlignVCenter);
    items.append(new QStandardItem(QString( "%L1" ) .arg(stats.averageBS,0,'f',2)+tr(" kts")));
    items[x]->setData(stats.averageBS,Qt::UserRole);
    items[x]->setData(n,Qt::UserRole+1);
    if(x%2!=0) items[x]->setData(QColor(240,240,240),Qt::BackgroundRole);
    items[x++]->setTextAlignment(Qt::AlignRight| Qt::AlignVCenter);
    items.append(new QStandardItem(QString( "%L1" ) .arg(stats.maxBS,0,'f',2)+tr(" kts")));
    items[x]->setData(stats.maxBS,Qt::UserRole);
    items[x]->setData(n,Qt::UserRole+1);
    if(x%2!=0) items[x]->setData(QColor(240,240,240),Qt::BackgroundRole);
    items[x++]->setTextAlignment(Qt::AlignRight| Qt::AlignVCenter);
    items.append(new QStandardItem(QString( "%L1" ) .arg(stats.minBS,0,'f',2)+tr(" kts")));
    items[x]->setData(stats.minBS,Qt::UserRole);
    items[x]->setData(n,Qt::UserRole+1);
    if(x%2!=0) items[x]->setData(QColor(240,240,240),Qt::BackgroundRole);
    items[x++]->setTextAlignment(Qt::AlignRight| Qt::AlignVCenter);
    items.append(new QStandardItem(QString( "%L1" ) .arg(stats.averageTWS,0,'f',2)+tr(" kts")));
    items[x]->setData(stats.averageTWS,Qt::UserRole);
    items[x]->setData(n,Qt::UserRole+1);
    if(x%2!=0) items[x]->setData(QColor(240,240,240),Qt::BackgroundRole);
    items[x++]->setTextAlignment(Qt::AlignRight| Qt::AlignVCenter);
    items.append(new QStandardItem(QString( "%L1" ) .arg(stats.maxTWS,0,'f',2)+tr(" kts")));
    items[x]->setData(stats.maxTWS,Qt::UserRole);
    items[x]->setData(n,Qt::UserRole+1);
    if(x%2!=0) items[x]->setData(QColor(240,240,240),Qt::BackgroundRole);
    items[x++]->setTextAlignment(Qt::AlignRight| Qt::AlignVCenter);
    items.append(new QStandardItem(QString( "%L1" ) .arg(stats.minTWS,0,'f',2)+tr(" kts")));
    items[x]->setData(stats.minTWS,Qt::UserRole);
    items[x]->setData(n,Qt::UserRole+1);
    if(x%2!=0) items[x]->setData(QColor(240,240,240),Qt::BackgroundRole);
    items[x++]->setTextAlignment(Qt::AlignRight| Qt::AlignVCenter);
